...
const MyPostComponent = () => {
  ...
  return (
    <>
    <div className="rounded-lg   sm:grid sm:grid-cols-1 md:grid md:grid-cols-2 xl:grid-cols-3 gap-1 text-black dark:text-white h-full overflow-y-auto no-scrollbar justify-center">
        {posts.length > 0 ? (
          posts.map(post => (
            <div
              key={post._id}
